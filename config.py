...
assert os.path.isfile('environment'), "File `environment` should be present"

load_dotenv('environment', verbose=True)


BACKEND = os.environ.get('BOT_BACKEND', 'XMPP')

# The location where all of Err's data should be stored. Make sure to set
# this to a directory that is writable by the user running the bot.

BOT_DATA_DIR = os.environ.get('BOT_DATA_DIR', '/srv/data')
...
CORE_PLUGINS = list(os.environ['CORE_PLUGINS'].split(',')) \
    if os.environ.get('CORE_PLUGINS') else None
if '-T' in sys.argv:
    CORE_PLUGINS.append('TextCmds')
...
SENTRY_LOGLEVEL = logging.getLevelName(os.environ.get('SENTRY_LOG_LEVEL', 'WARNING'))
...
BOT_ADMINS_NOTIFICATION = BOT_ADMINS
